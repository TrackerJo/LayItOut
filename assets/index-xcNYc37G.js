 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ut{constructor(t,n,s,i,o,r,d,c,p,h,g,R=!0,l=!1){this.url_=t,this.method_=n,this.headers_=s,this.body_=i,this.successCodes_=o,this.additionalRetryCodes_=r,this.callback_=d,this.errorCallback_=c,this.timeout_=p,this.progressCallback_=h,this.connectionFactory_=g,this.retry=R,this.isUsingEmulator=l,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((f,I)=>{this.resolve_=f,this.reject_=I,this.start_()})}start_(){const t=(s,i)=>{if(i){s(!1,new O(!1,null,!0));return}const o=this.connectionFactory_();this.pendingConnection_=o;const r=d=>{const c=d.loaded,p=d.lengthComputable?d.total:-1;this.progressCallback_!==null&&this.progressCallback_(c,p)};this.progressCallback_!==null&&o.addUploadProgressListener(r),o.send(this.url_,this.method_,this.isUsingEmulator,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&o.removeUploadProgressListener(r),this.pendingConnection_=null;const d=o.getErrorCode()===D.NO_ERROR,c=o.getStatus();if(!d||Et(c,this.additionalRetryCodes_)&&this.retry){const h=o.getErrorCode()===D.ABORT;s(!1,new O(!1,null,h));return}const p=this.successCodes_.indexOf(c)!==-1;s(!0,new O(p,o))})},n=(s,i)=>{const o=this.resolve_,r=this.reject_,d=i.connection;if(i.wasSuccessCode)try{const c=this.callback_(d,d.getResponse());Tt(c)?o(c):o()}catch(c){r(c)}else if(d!==null){const c=Q();c.serverResponse=d.getErrorText(),this.errorCallback_?r(this.errorCallback_(d,c)):r(c)}else if(i.canceled){const c=this.appDelete_?le():It();r(c)}else{const c=bt();r(c)}};this.canceled_?n(!1,new O(!1,null,!0)):this.backoffId_=Nt(t,n,this.timeout_)}getPromise(){return this.promise_}cancel(t){this.canceled_=!0,this.appDelete_=t||!1,this.backoffId_!==null&&_t(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class O{constructor(t,n,s){this.wasSuccessCode=t,this.connection=n,this.canceled=!!s}}function Bt(e,t){t!==null&&t.length>0&&(e.Authorization="Firebase "+t)}function Pt(e,t){e["X-Firebase-Storage-Version"]="webjs/"+(t??"AppManager")}function St(e,t){t&&(e["X-Firebase-GMPID"]=t)}function Mt(e,t){t!==null&&(e["X-Firebase-AppCheck"]=t)}function Ot(e,t,n,s,i,o,r=!0,d=!1){const c=ce(e.urlParams),p=e.url+c,h=Object.assign({},e.headers);return St(h,t),Bt(h,n),Pt(h,o),Mt(h,s),new Ut(p,e.method,h,e.body,e.successCodes,e.additionalRetryCodes,e.handler,e.errorHandler,e.timeout,e.progressCallback,i,r,d)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lt(){return typeof BlobBuilder<"u"?BlobBuilder:typeof WebKitBlobBuilder<"u"?WebKitBlobBuilder:void 0}function Gt(...e){const t=Lt();if(t!==void 0){const n=new t;for(let s=0;s<e.length;s++)n.append(e[s]);return n.getBlob()}else{if(V())return new Blob(e);throw new w(y.UNSUPPORTED_ENVIRONMENT,"This browser doesn't seem to support creating Blobs")}}function Ht(e,t,n){return e.webkitSlice?e.webkitSlice(t,n):e.mozSlice?e.mozSlice(t,n):e.slice?e.slice(t,n):null}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Re="storage";function In(e,t,n){return e=G(e),hn(e,t,n)}function yn(e){return e=G(e),mn(e)}function wn(e,t){return e=G(e),An(e,t)}function Rn(e=Ue(),t){e=G(e);const s=Be(e,Re).getImmediate({identifier:t}),i=Pe("storage");return i&&xn(s,...i),s}function xn(e,t,n,s={}){bn(e,t,n,s)}function vn(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),i=e.getProvider("app-check-internal");return new Y(n,s,i,t,Te)}function Cn(){Ne(new _e(Re,vn,"PUBLIC").setMultipleInstances(!0)),K(te,ne,""),K(te,ne,"esm2020")}Cn();const jn=Rn(Le);async function kn(e,t){const n=localStorage.getItem("companyId"),s=wn(jn,`${n}/CustomItems/${t.replace(" ","_")}.${e.name.split(".").pop()}`),i=await In(s,e);return await yn(i.ref)}function Nn({dialogRef:e,closeDialog:t,createCustomItem:n}){const[s,i]=A.useState(null),[o,r]=A.useState(""),[d,c]=A.useState(1),[p,h]=A.useState(1),[g,R]=A.useState(!0),l=A.useRef(null);return a.jsx("dialog",{ref:e,className:"custom-item-dialog",children:a.jsxs("div",{className:"custom-item-dialog-div",children:[a.jsx("h2",{children:"Create Custom Item"}),a.jsxs("div",{className:"custom-item-row",children:[a.jsx("label",{htmlFor:"item-name",children:"Name:"}),a.jsx("input",{type:"text",id:"item-name",name:"item-name",onChange:f=>r(f.target.value??""),value:o})]}),a.jsxs("div",{className:"custom-item-row",children:[a.jsx("label",{htmlFor:"item-icon",children:"Icon:"}),a.jsx("input",{type:"file",id:"item-icon",name:"item-icon",ref:l,accept:".png,.jpeg,.svg,.webp,.jpg"})]}),a.jsxs("div",{className:"custom-item-row custom-item-size",children:[a.jsx("label",{htmlFor:"item-width",children:"Size (in feet):"}),a.jsx("input",{type:"number",id:"item-width",name:"item-width",min:"1",value:d,onChange:f=>c(parseFloat(f.target.value)??1)}),a.jsx("span",{children:" x "}),a.jsx("input",{type:"number",id:"item-height",name:"item-height",min:"1",value:p,onChange:f=>h(parseFloat(f.target.value)??1)})]}),a.jsxs("div",{children:[a.jsx("label",{htmlFor:"item-moveable",children:"Moveable:"}),a.jsx("input",{type:"checkbox",id:"item-moveable",name:"item-moveable",checked:g,onChange:f=>R(f.target.checked)})]}),a.jsx("br",{}),a.jsx("br",{}),a.jsx("button",{className:"action-btn",onClick:async()=>{if(o.trim()===""&&s==null){alert("Item name cannot be empty");return}if(l.current?.files==null||l.current.files.length===0){alert("Please select an icon file for the item");return}const f=await kn(l.current.files[0],o);let I=s;I==null&&(I=new Ge({id:o+(Math.random()*1e4).toString(),name:o,icon:f,cellsLong:Math.ceil(d),cellsTall:Math.ceil(p),moveable:g})),n(I),R(!0),i(null),r(""),c(1),h(1),l.current&&(l.current.value=""),t()},children:"Add Item"}),a.jsx("button",{className:"action-btn",onClick:t,children:"Close"})]})})}ve.createRoot(document.getElementById("root")).render(a.jsx(_n,{}));function _n(){const[e,t]=A.useState(/Mobi|Android/i.test(navigator.userAgent)),[n,s]=A.useState("designs"),[i,o]=A.useState([]),[r,d]=A.useState([]),[c,p]=A.useState([]),[h,g]=A.useState([]),[R,l]=A.useState(!0),f=A.useRef(null),I=A.useRef(null),b=A.useRef(null),j=A.useRef(null),C=A.useRef(null);return A.useEffect(()=>{He();const m=new URLSearchParams(window.location.search).get("view");m==="designs"?s("designs"):m==="areas"?s("areas"):m==="boothmaps"?s("boothmaps"):m==="items"&&s("items");async function U(){const N=localStorage.getItem("companyId");if(!N){se();return}const P=await Xe(N),B=[];(await Promise.all(P.map(T=>Ke(N,T.id)))).forEach(T=>{B.push(...T)});const X=[];(await Promise.all(P.map(T=>qe(N,T.id)))).forEach(T=>{X.push(...T)});const xe=await $e(N);g([...xe]),d([...P]),o([...X]),p([...B]),l(!1)}U()},[]),a.jsxs(a.Fragment,{children:[a.jsxs("div",{className:"App",children:[a.jsx("h1",{className:"title",children:"LayItOut"}),R&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"loader-backdrop"}),a.jsx("div",{className:"loader"})]}),a.jsxs("div",{className:"dashboard",children:[a.jsxs("div",{className:"sidebar",children:[a.jsx("div",{className:"account-div",children:a.jsx("img",{src:nt,alt:"Account Icon",className:"account-icon",onClick:()=>{f.current?.showModal()}})}),a.jsxs("div",{className:"nav-buttons",children:[a.jsx("button",{className:`nav-button ${n=="designs"?"selected":""}`,onClick:()=>s("designs"),children:"Designs"}),a.jsx("button",{className:`nav-button ${n=="boothmaps"?"selected":""}`,onClick:()=>s("boothmaps"),children:"Booth Maps"}),a.jsx("button",{className:`nav-button ${n=="areas"?"selected":""}`,onClick:()=>s("areas"),children:"Areas"}),a.jsx("button",{className:`nav-button ${n=="items"?"selected":""}`,onClick:()=>s("items"),children:"Inventory Items"})]})]}),a.jsxs("div",{className:"content",children:[n=="designs"&&i.length==0&&a.jsx("div",{className:"no-designs",children:a.jsx("h3",{children:"No Designs Yet"})}),n=="areas"&&r.length==0&&a.jsx("div",{className:"no-areas",children:a.jsx("h3",{children:"No Areas Yet"})}),n=="boothmaps"&&c.length==0&&a.jsx("div",{className:"no-boothmaps",children:a.jsx("h3",{children:"No Booth Maps Yet"})}),n=="items"&&h.length==0&&a.jsx("div",{className:"no-items",children:a.jsx("h3",{children:"No Custom Items Yet"})}),n=="areas"&&a.jsx("div",{className:"area-tiles",children:r.map(u=>a.jsx(at,{area:u,onClick:()=>{const m=localStorage.getItem("companyId");window.location.href=`/Layout/?companyId=${m}&areaId=${u.id}&type=view-area`},deleteArea:async()=>{d(r.filter(m=>m.id!==u.id)),o(i.filter(m=>m.areaId!==u.id)),l(!0),await Ze(localStorage.getItem("companyId"),u.id),l(!1)}},u.id))}),n=="designs"&&a.jsx("div",{className:"design-tiles",children:i.map(u=>a.jsx(ot,{areaName:r.find(m=>m.id==u.areaId)?.name||"",design:u,onClick:()=>{const m=localStorage.getItem("companyId");window.location.href=`/Layout/?companyId=${m}&areaId=${u.areaId}&type=view-design&designId=${u.id}&designName=${u.name}`},deleteDesign:async()=>{o(i.filter(m=>m.id!==u.id)),l(!0),await Fe(localStorage.getItem("companyId"),u.areaId,u.id),l(!1)}},u.id))}),n=="boothmaps"&&a.jsx("div",{className:"boothmap-tiles",children:c.map(u=>a.jsx(ut,{areaName:r.find(m=>m.id==u.areaId)?.name||"",boothMap:u,onClick:()=>{const m=localStorage.getItem("companyId");window.location.href=`/Layout/?companyId=${m}&areaId=${u.areaId}&type=view-boothMap&boothMapId=${u.id}&boothMapName=${u.name}`},deleteBoothMap:async()=>{p(c.filter(m=>m.id!==u.id)),l(!0),await Je(localStorage.getItem("companyId"),u.areaId,u.id),l(!1)}},u.id))}),n=="items"&&a.jsx("div",{className:"custom-item-tiles",children:h.map(u=>a.jsx(tt,{item:u,onSelect:()=>{},canDelete:!0,onDelete:async()=>{g(h.filter(m=>m.id!==u.id)),l(!0),await Qe(localStorage.getItem("companyId"),u.id),l(!1)}},u.id))}),n=="designs"||!e?a.jsx("div",{className:"plus-icon",onClick:()=>{n=="designs"?I.current?.showModal():n=="boothmaps"?j.current?.showModal():n=="areas"?b.current?.showModal():n=="items"&&C.current?.showModal()},children:a.jsx("img",{src:st,alt:"Plus Icon"})}):null]})]})]}),a.jsx(it,{areas:r,dialogRef:I,closeDialog:()=>I.current?.close(),createDesign:async u=>{o([...i,u]),await ze(localStorage.getItem("companyId"),u.areaId,u),I.current?.close()}}),a.jsx(rt,{dialogRef:f,closeDialog:()=>f.current?.close()}),a.jsx(lt,{dialogRef:b,closeDialog:()=>b.current?.close(),createArea:async u=>{await Ve(localStorage.getItem("companyId"),u),d([...r,u]),b.current?.close(),window.location.href=`/Layout/?companyId=${localStorage.getItem("companyId")}&areaId=${u.id}&type=create-area&stage=placing-sections`}}),a.jsx(ct,{areas:r,dialogRef:j,closeDialog:()=>j.current?.close(),createBoothMap:async u=>{p([...c,u]),await We(localStorage.getItem("companyId"),u.areaId,u),j.current?.close()}}),a.jsx(Nn,{dialogRef:C,closeDialog:()=>C.current?.close(),createCustomItem:async u=>{await Ye(localStorage.getItem("companyId"),u),g([...h,u]),C.current?.close()}})]})}
